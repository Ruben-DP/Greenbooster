...
import { TextField, SelectField, CheckboxField, ReferenceField } from "@/components/atoms";
import { ImageSelect } from "@/components/molecules";
...
const ResidenceForm = ({
  ...
  return (
    <div className={`form ${styles["residence-form"]}`}>
