...
import { TextField, SelectField } from "@/components/atoms";
  ...
  return (
    <div className={`${containerClassName} ${compact ? "type-form--compact" : ""}`}>
      <div className={styles["type-title"]}>
        <div className={styles["title-fields-container"]} style={{ display: "flex", gap: "20px" }}>
          <TextField
            label="Naam"
      ...
      <div className={styles["type-form"]}>
        <div className={styles["form__section"]}>
          <h4 className={styles["form__heading"]}>Voorgevel Kozijnen</h4>
        ...
        <div className={styles["form__section"]}>
          <h4 className={styles["form__heading"]}>Achtergevel Kozijnen</h4>
          <div className={styles["form__fields"]}>
            <WindowInputs
        ...
        <div className={styles["form__section"]}>
          <h4 className={styles["form__heading"]}>Ruimten</h4>
          <div className={styles["form__fields"]}>
            {[
              "woonkamer",
              "achterkamer",
